...
interface ResultProps{
    ...
    deleteItem: (listId: string) => void;
  }

export default function ExitBalance({lists, deleteItem}: ResultProps) {
    ...
    const months = useMemo(() => {
      ...
      const handleDeleteItem = async (listId: string) => {
        try {
            ...
            await apiClient.delete(`/exit-balance/remove?order_id=${listId}`);
